                ...
                if (techniques.hasOwnProperty(techniqueId)) {
                    ...
                    if (parameters) {
                        for (let parameterId in parameters) {
                            // CESIUM_RTC_MODELVIEW semantics if the CESIUM_RTC extension is present
                            if (parameterId === 'modelViewMatrix') {
                                parameters[parameterId].semantic = 'CESIUM_RTC_MODELVIEW';
                            }

                            // BATCHID to _BATCHID
                            // if (parameterId === 'batchId'){
                            //     parameters[parameterId].semantic = '_BATCHID';
                            // }
                        }
                    }
                }
